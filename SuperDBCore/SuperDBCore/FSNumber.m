...
{
  if (a && object_getClass(a) == FSNumberClass && b && object_getClass(b) == FSNumberClass)
  {
...
{
  if (anObject && object_getClass(anObject) == FSNumberClass) // direct isa access for better performance
